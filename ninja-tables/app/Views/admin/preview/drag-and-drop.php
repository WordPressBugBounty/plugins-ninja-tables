    ...
    <div class="nt_preview">
        <div class="nt_preview_header">
            <div class="nt_preview_header_title">
                [ninja_table_builder id="<?php
                echo esc_attr($table_id); ?>"]
            </div>
            <div class="nt_preview_header_action">
                <a href="<?php
                echo esc_url(admin_url('admin.php?page=ninja_tables#/table_builder_edit_table/' . $table_id)) ?>"><?php
        ...
        <div class="nt_preview_body">
            <div class="nt_preview_body_wrapper">
                <?php
                echo do_shortcode('[ninja_table_builder id="' . esc_attr($table_id) . '"]'); ?>
            </div>
        </div>
        ...
        <div class="nt_preview_footer">
            <p class="nt_preview_footer_text">You are seeing preview version of Ninja Tables. This table is only
                accessible for Admin users. Other users may not access this page. To use this in a page please use the following shortcode:
                [ninja_table_builder id='<?php echo esc_attr($table_id) ?>']</p>
        </div>
    </div>
</div>
<?php
