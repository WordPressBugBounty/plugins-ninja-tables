...
use NinjaTables\Framework\Database\Orm\RelationNotFoundException;
use NinjaTables\Framework\Database\Orm\Concerns\QueriesRelationships;
...
class Builder
{
     ...
     *
     * @var \NinjaTables\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \NinjaTables\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @return \NinjaTables\Framework\Database\Orm\Model|static
     */
     ...
     * @param  \NinjaTables\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \NinjaTables\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\NinjaTables\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\NinjaTables\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\NinjaTables\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\NinjaTables\Framework\Database\Query\Expression  $column
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NinjaTables\Framework\Database\Orm\Model|\NinjaTables\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NinjaTables\Framework\Database\Orm\Model|\NinjaTables\Framework\Database\Orm\Collection|static|static[]
     *
     ...
     * @return \NinjaTables\Framework\Database\Orm\Model|static|mixed
     */
     ...
     *
     * @throws \NinjaTables\Framework\Database\Orm\ModelNotFoundException
     * @throws \NinjaTables\Framework\Database\MultipleRecordsFoundException
     */
     ...
     * @return mixed
     *
     * @throws \NinjaTables\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \NinjaTables\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string  $name
     * @return \NinjaTables\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @return \NinjaTables\Framework\Pagination\LengthAwarePaginator
     *
     ...
     *
     * @param  array  $attributes
     * @return \NinjaTables\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  array|\NinjaTables\Framework\Database\Query\Expression  $columns
     * @return array
     */
