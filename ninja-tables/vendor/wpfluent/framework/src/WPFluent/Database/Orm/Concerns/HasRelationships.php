...
namespace NinjaTables\Framework\Database\Orm\Concerns;
...
use NinjaTables\Framework\Database\Orm\Builder;
use NinjaTables\Framework\Database\Orm\Collection;
use NinjaTables\Framework\Database\Orm\Relations\Pivot;
use NinjaTables\Framework\Database\Orm\Relations\HasOne;
use NinjaTables\Framework\Database\Orm\Relations\HasMany;
use NinjaTables\Framework\Database\Orm\Relations\MorphTo;
use NinjaTables\Framework\Database\Orm\Relations\BelongsTo;
use NinjaTables\Framework\Database\Orm\Relations\MorphMany;
use NinjaTables\Framework\Database\Orm\Relations\MorphOne;
use NinjaTables\Framework\Database\Orm\Relations\MorphToMany;
...
use NinjaTables\Framework\Database\Orm\Relations\HasOneThrough;
use NinjaTables\Framework\Database\Orm\Relations\Relation;
use NinjaTables\Framework\Database\ClassMorphViolationException;
use NinjaTables\Framework\Database\Orm\PendingHasThroughRelationship;
...
trait HasRelationships
{
     ...
     *
     * @param  \NinjaTables\Framework\Database\Orm\Builder  $query
     * @param  \NinjaTables\Framework\Database\Orm\Model  $farParent
     * @param  \NinjaTables\Framework\Database\Orm\Model  $throughParent
     ...
     * @return \NinjaTables\Framework\Database\Orm\Relations\BelongsTo
     */
     ...
     *
     * @param  \NinjaTables\Framework\Database\Orm\Builder  $query
     * @param  \NinjaTables\Framework\Database\Orm\Model  $child
     * @param  string  $foreignKey
     ...
     * @param  string|null  $id
     * @param  string|null  $ownerKey
     * @return \NinjaTables\Framework\Database\Orm\Relations\MorphTo
     */
     ...
     *
     * @param  string|\NinjaTables\Framework\Database\Orm\Relations\HasMany<TIntermediateModel, covariant $this>|\NinjaTables\Framework\Database\Orm\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \NinjaTables\Framework\Database\Orm\PendingHasThroughRelationship<\NinjaTables\Framework\Database\Orm\Model, $this>
     *     : \NinjaTables\Framework\Database\Orm\PendingHasThroughRelationship<TIntermediateModel, $this>
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \NinjaTables\Framework\Database\Orm\Relations\HasMany
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \NinjaTables\Framework\Database\Orm\Relations\HasManyThrough
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \NinjaTables\Framework\Database\Orm\Relations\MorphMany
     */
     ...
     * @param  string|null  $relation
     * @return \NinjaTables\Framework\Database\Orm\Relations\BelongsToMany
     */
     ...
     *
     * @param  string  $related
     * @param  \NinjaTables\Framework\Database\Orm\Model|null  $instance
     * @return string
     */
