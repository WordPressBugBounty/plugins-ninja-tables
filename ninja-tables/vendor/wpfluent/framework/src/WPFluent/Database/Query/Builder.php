...
class Builder
{
     ...
     *
     * @var \NinjaTables\Framework\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\NinjaTables\Framework\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \NinjaTables\Framework\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \NinjaTables\Framework\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \NinjaTables\Framework\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  string  $column
     * @param  \NinjaTables\Framework\Support\ArrayableInterface|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  \Closure|\NinjaTables\Framework\Database\Query\Builder|\NinjaTables\Framework\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \NinjaTables\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \NinjaTables\Framework\Database\RecordsNotFoundException
     ...
     *
     * @param  \NinjaTables\Framework\Support\Collection  $items
     * @return \NinjaTables\Framework\Support\Collection
     */
