...
use NinjaTables\Framework\Support\Conditionable;
...
use NinjaTables\Framework\Database\MultipleRecordsFoundException;
...
use NinjaTables\Framework\Pagination\LengthAwarePaginator;
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\NinjaTables\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \NinjaTables\Framework\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  \NinjaTables\Framework\Database\Query\Builder|\NinjaTables\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \NinjaTables\Framework\Pagination\Paginator
     */
     ...
     * @param  \NinjaTables\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \NinjaTables\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \NinjaTables\Framework\Pagination\CursorPaginator
     */
